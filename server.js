...
app.get('/', async (req,res)=>{ // listen to get a request
    //res.send("Hello World!"); // send "Hello World!" as a test response for the localhost:5001
...
app.listen(PORT, ()=>{ // listen to the port we chose above (5001)
