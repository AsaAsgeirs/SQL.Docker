...
function App() {
  ...
  // the first item (here called gretting) is the value that you pass as an argument to use state, in this case an empty strin ("")
  ...
  // useEffect is a function that takes a function and an array as argument. The function runs once when the component loads
  // and then again if any of the state variables in the array are changed. What matters most here is that if you leve the array empty
  ...
  useEffect(()=>{
    const getGreeting = async()=>{ // to be able to use async and await in useEffect we need to create an async function.
      ...
      // this collection has only one document and our object represents the data in that document.
